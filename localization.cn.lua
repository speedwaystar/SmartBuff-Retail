...
SMARTBUFF_FROST_ARMOR = "霜甲术";
SMARTBUFF_MAGE_ARMOR = "法师护甲";
SMARTBUFF_MOLTEN_ARMOR = "熔岩护甲";
SMARTBUFF_DAMPENMAGIC = "魔法抑制";
SMARTBUFF_AMPLIFYMAGIC = "魔法增效";
SMARTBUFF_MANA_SHIELD = "法力护盾";
SMARTBUFF_FIREWARD = "防护火焰结界";
SMARTBUFF_FROSTWARD = "防护冰霜结界";
SMARTBUFF_ICE_BARRIER = "寒冰护体";
SMARTBUFF_COMBUSTION = "燃烧";
SMARTBUFF_ARCANE_POWER = "奥术强化";
SMARTBUFF_PRESENCE_OF_MIND = "气定神闲";
SMARTBUFF_ICY_VEINS = "冰冷血脉";
...
-- 战士
SMARTBUFF_BATTLE_SHOUT = "战斗怒吼";
SMARTBUFF_COMMANDING_SHOUT = "命令怒吼";
SMARTBUFF_BERSERKER_RAGE = "狂暴之怒";
...
-- 圣骑士
SMARTBUFF_RIGHTEOUS_FURY = "正义之怒";
SMARTBUFF_HOLYSHIELD = "神圣之盾";
SMARTBUFF_BLESSING_OF_MIGHT = "力量祝福";
SMARTBUFF_GBOM = "强效力量祝福";
SMARTBUFF_BLESSING_OF_WISDOM = "智慧祝福";
SMARTBUFF_GBOW = "强效智慧祝福";
SMARTBUFF_BOSAL = "拯救祝福";
SMARTBUFF_GBOSAL = "强效拯救祝福";
SMARTBUFF_BLESSING_OF_KINGS = "王者祝福";
...
SMARTBUFF_BOF = "自由祝福";
SMARTBUFF_BOP = "保护祝福";
SMARTBUFF_SEAL_OF_COMMAND = "命令圣印";
SMARTBUFF_SOFURY = "愤怒圣印";
SMARTBUFF_SEAL_OF_JUSTICE = "公正圣印";
SMARTBUFF_SOLIGHT = "光明圣印";
SMARTBUFF_SEAL_OF_RIGHTEOUSNESS = "正义圣印";
SMARTBUFF_SOWISDOM = "智慧圣印";
SMARTBUFF_SOTCRUSADER = "十字军圣印";
SMARTBUFF_SOVENGEANCE = "复仇圣印";
SMARTBUFF_SOBLOOD = "鲜血圣印";
SMARTBUFF_DEVOTION_AURA = "虔诚光环";
SMARTBUFF_RETRIBUTION_AURA = "惩罚光环";
